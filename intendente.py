...
import sqlite3
from inten_pasajes import pasaje
from inten_subsidio import subsidio
from inten_modulo import modulo
from inten_vivienda import vivienda
from inten_tarjeta import tarjeta
...
miImagen = PhotoImage(file="logo5.png")
...
imagen1 = PhotoImage(file="sub.png")
...
imagen2 = PhotoImage(file="pasaje.png")
...
imagen3 = PhotoImage(file="modulo.png")
...
imagen4 = PhotoImage(file="vivienda.png")
...
imagen5 = PhotoImage(file="tarjeta.png")
