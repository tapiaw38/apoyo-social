...
def ven_pas():
    ...
    def guardaDatos():
        ...
        if borra1.get() == "":
            ...
            miCursor.execute("INSERT INTO pasajes VALUES(NULL, '" + borra1.get() +
                             "','" + borra2.get() +
                             "','" + borra4.get() +
                             "','" + borra5.get() +
    ...
    # -------------------------------------------
    etiqueta3 = Label(ventana, text="Destino")
    ...
    # --------------------------------------------
    etiqueta4 = Label(ventana, text="Monto (sin puntos)")
    ...
    # --------------------------------------------
    etiqueta5 = Label(ventana, text="Motivo")
